...
export const menuItems: MenuItem[] = [
  ...
  {
    key: 'profile',
    titleKey: 'menu.profile.title',
    icon: User,
    minRoleLevel: 1,
    requiredPermissions: ['profile:view:own'],
    children: [
      {
        key: 'profile_view',
        titleKey: 'menu.profile.myProfile',
        icon: UserCircle,
        path: '/profile',
        minRoleLevel: 1,
        requiredPermissions: ['profile:view:own'],
      ...
      },
      {
        ...
        titleKey: 'menu.profile.settings',
        icon: Settings,
  ...
  },
  {
    ...
    children: [
      {
        key: 'calendar_view',
        titleKey: 'menu.calendar.myCalendar',
        icon: CalendarDays,
        path: '/calendar',
        minRoleLevel: 1,
        requiredPermissions: ['calendar:view:own'],
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: 'messages_compose',
        titleKey: 'menu.messages.compose',
        icon: MailPlus,
        path: '/messages/compose',
        minRoleLevel: 1,
        requiredPermissions: ['message:send:own'],
      },
    ],
  },
  {
